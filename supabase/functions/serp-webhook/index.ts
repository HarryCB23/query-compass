    ...
    try {
      ...
      const { error: upsertError } = await svc
        ...
        .upsert({
          ...
          has_paa:                summary.has_paa,
          has_knowledge_graph:    summary.has_knowledge_graph,
          ...
          publisher_in_paa:                 summary.publisher_in_paa,
          publisher_in_knowledge_graph:     summary.publisher_in_knowledge_graph,
          publisher_in_video:               summary.publisher_in_video,
